...
public final class BerlinNightTheme: CommonTheme, @unchecked Sendable {
    public init() {
        super.init(
            id: "berlinNight",
    ...
    public final class Colors: ThemeColorsProtocol, @unchecked Sendable {
        ...
        public let fgAccent = UIColor(rgbHex: 0xF4F4F5)
        public let fgAccentInverted = UIColor(rgbHex: 0x0B0C0F)
        ...
        public let bgSurfaceAccent = UIColor(rgbHex: 0xFFFFFF)
        public let bgSurfaceAccentInverted = UIColor(rgbHex: 0x1A1A1A)
        public let bgSurfaceAccentSoft = UIColor(rgbHex: 0xF7F7F8)
        public let bgSurfaceAccentSoftInverted = UIColor(rgbHex: 0x23252A)
        ...
        public let bgActionError = UIColor(rgbHex: 0x3B0D10)
        public let bgActionAccent = UIColor(rgbHex: 0xDADBE0)
        public let bgActionAccentInverted = UIColor(rgbHex: 0x0B0C0F)
        ...
        public let strokeAccent = UIColor(rgbHex: 0x8C8F98)
        public let strokeAccentSoft = UIColor(rgbHex: 0xA9ABB3)
