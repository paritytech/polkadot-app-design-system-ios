...
public final class LisbonTheme: CommonTheme, @unchecked Sendable {
    ...
    public final class Colors: ThemeColorsProtocol, @unchecked Sendable {
        ...
        public let fgAccent = UIColor(rgbHex: 0xC2410C)
        public let fgAccentInverted = UIColor(rgbHex: 0xC2410C)
        ...
        public let bgSurfaceAccent = UIColor(rgbHex: 0xC2410C)
        public let bgSurfaceAccentInverted = UIColor(rgbHex: 0x1A1A1A)
        public let bgSurfaceAccentSoft = UIColor(rgbHex: 0xFFEDD5)
        public let bgSurfaceAccentSoftInverted = UIColor(rgbHex: 0xFFEDD5)
        ...
        public let bgActionAccent = UIColor(rgbHex: 0xC2410C)
        public let bgActionAccentInverted = UIColor(rgbHex: 0xFFEDD5)
        ...
        public let strokeAccent = UIColor(rgbHex: 0xC2410C)
        public let strokeAccentSoft = UIColor(rgbHex: 0xD9935A)
