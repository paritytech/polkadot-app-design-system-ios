...
public final class LisbonTheme: CommonTheme, @unchecked Sendable {
    public init() {
        super.init(
            id: "lisbon",
    ...
    public final class Colors: ThemeColorsProtocol, @unchecked Sendable {
        ...
        public let fgPrimary = UIColor(rgbHex: 0x431407)
        public let fgPrimaryInverted = UIColor(rgbHex: 0xF4F4F5)
        public let fgSecondaryInverted = UIColor(rgbHex: 0xFFF7ED)
        public let fgTertiaryInverted = UIColor(rgbHex: 0xFFEDD5)
        ...
        public let bgSelectionContainerHover = UIColor(rgbHex: 0xFFF7ED)
        public let bgSelectionContainerActive = UIColor(rgbHex: 0xFFEDD5)
        public let bgSelectionContainerHoverInverted = UIColor(rgbHex: 0x431407)
        ...
        public let strokePrimary = UIColor(rgbHex: 0xFED7AA)
